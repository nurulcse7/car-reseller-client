...
const BmwBookingModal = ({ carInfo, setCarInfo, refetch }) => {
  ...
  const handleBmwBooking = (event) => {
    ...
    // };
    fetch('https://car-reseller-server.vercel.app/bmwBookings', {
      method: 'POST',
      headers: {
      ...
      .then((data) => {
        ...
        if (data.acknowledged) {
          setCarInfo(null);
          toast.success('You have booked a BMW car');
          refetch();
        } else {
...
export default BmwBookingModal;
